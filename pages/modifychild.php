...
<body>
  ...
  <form class="child-form" action="../src/update_child.php" method="post" enctype="multipart/form-data">
    <h2>Update Child </h2>
    <a href="/orphan/pages/dashboard.php" class="cancel"><i class="bi bi-x-circle"></i></a>
    ...
    <div class="form-group">
      ...
      <select name="status" required>
        <option value="">Select</option>
        <option value="Fully Sponsored" <?php echo ($child['status'] == 'Fully Sponsored') ? 'selected' : ''; ?>>Fully
          Sponsored</option>
        <option value="Partially Sponsored" <?php echo ($child['status'] == 'Partially Sponsored') ? 'selected' : ''; ?>>
          Partially Sponsored</option>
        <option value="Not Sponsored" <?php echo ($child['status'] == 'Not Sponsored') ? 'selected' : ''; ?>>Not Sponsored
        </option>
      </select>
    </div>
